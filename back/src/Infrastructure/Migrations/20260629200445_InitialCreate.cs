        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoUrl = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumJobValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkerAvailabilities_WorkerProfiles_WorkerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerPortfolioItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkerPortfolioItems_WorkerProfiles_WorkerProfileId",
                        column: x => x.WorkerProfileId,
                        principalTable: "WorkerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialsIncluded = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvailableCities = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkerServices_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_WorkerServices_WorkerServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_WorkerProfiles_WorkerProfileId",
                        column: x => x.WorkerProfileId,
                        principalTable: "WorkerProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Favorites_WorkerServices_WorkerServiceId",
                        column: x => x.WorkerServiceId,
                        principalTable: "WorkerServices",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceImages_WorkerServices_WorkerServiceId",
                        column: x => x.WorkerServiceId,
                        principalTable: "WorkerServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommissionAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    WorkerAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_WorkerServiceId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_CustomerId_WorkerProfileId_WorkerServiceId",
                table: "Favorites",
                columns: new[] { "CustomerId", "WorkerProfileId", "WorkerServiceId" });

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_WorkerProfileId",
                table: "Favorites",
                column: "WorkerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_WorkerServiceId",
                table: "Favorites",
                column: "WorkerServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceImages_WorkerServiceId",
                table: "ServiceImages",
                column: "WorkerServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerAvailabilities_WorkerProfileId",
                table: "WorkerAvailabilities",
                column: "WorkerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkerPortfolioItems_WorkerProfileId",
                table: "WorkerPortfolioItems",
                column: "WorkerProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerServices_WorkerProfileId",
                table: "WorkerServices",
                column: "WorkerProfileId");
        }
