...
public interface IBookingService
{
    ...
    Task<PagedResponse<BookingResponse>> GetCustomerBookingsAsync(int customerId, BookingFilterRequest filter);
    Task<PagedResponse<BookingResponse>> GetWorkerBookingsAsync(int workerProfileId, BookingFilterRequest filter);
