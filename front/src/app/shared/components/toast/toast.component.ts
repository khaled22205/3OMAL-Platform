...
@Component({
  ...
  template: `
    <div
      class="fixed bottom-6 left-6 z-[9999] flex flex-col gap-3 max-w-sm w-full pointer-events-none"
    >
      @for (toast of toastService.toasts(); track toast.id) {
        ...
        >
          ...
          <p class="text-sm font-medium flex-grow text-right leading-relaxed">
            {{ toast.message }}
          </p>
